...
- [![](assets/xonsh.png)xonsh](http://xon.sh) <!--   https://github.com/xonsh/xonsh -->
- [![](assets/astropy.png)Astropy](https://www.astropy.org/) <!--   https://github.com/astropy/astropy -->
- [![](assets/geopy.png)geopy](https://geopy.readthedocs.io/) <!--   https://github.com/geopy/geopy -->
- [![](assets/biopython.png)Biopython](https://biopython.org/) <!--   https://github.com/biopython/biopython -->
- [![](assets/nikola.png)Nikola](https://getnikola.com) <!--   https://github.com/getnikola/nikola -->
...
- [![](assets/xarray.png)xarray](https://xarray.pydata.org/) <!--   https://github.com/pydata/xarray -->
- [![](assets/dateutil.png)dateutil](https://github.com/dateutil/dateutil) <!-- url:https://github.com/dateutil/dateutil sg:974 -->
- [![](//cherrypy.org/images/cherrypy.png)CherryPy](https://cherrypy.org/) <!--   https://github.com/cherrypy/cherrypy -->
...
- [![](assets/mne.png)MNE](https://www.martinos.org/mne/stable/index.html) <!--   https://github.com/mne-tools/mne-python -->
...
- [![](assets/cartopy.png)Cartopy](https://scitools.org.uk/cartopy/docs/latest/) <!--   https://github.com/SciTools/cartopy -->
